...
public delegate void OnGrabbedEvent(OVRGrabber hand, Collider grabPoint);
public delegate void OnReleasedEvent(Vector3 linearVelocity, Vector3 angularVelocity);
...
public class OVRGrabbable : MonoBehaviour
{
    ...
    public event OnGrabbedEvent OnGrabbed;
    public event OnReleasedEvent OnReleased;
    ...
    {
        //only invoke Ongrabbed if it's not null
        OnGrabbed?.Invoke(hand, grabPoint);
