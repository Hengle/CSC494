...
public class SimpleFPSController : TeleportController {
	...
	public void Update() {
		//look
		var lookDelta = new Vector2(Input.GetAxisRaw("Mouse X"), Input.GetAxisRaw("Mouse Y")) * lookSpeed * Time.deltaTime;
