...
public class OVRGrabber : MonoBehaviour
{
    ...
    [NonSerialized] public Quaternion m_anchorOffsetRotation;
    [NonSerialized] public Vector3 m_anchorOffsetPosition;
    ...
    protected Transform actualParent = null;

    public Dictionary<GameObject, int> includes = new Dictionary<GameObject, int>();
    ...
    void LateUpdate()
    {
        ...
        foreach (var key in includes.Keys.ToList())
        {
            includes[key] = includes[key] + 1;
    ...
    void OnTriggerStay(Collider otherCollider)
    {
        ...
        includes[otherCollider.gameObject] = 0;
    }
    ...
    protected virtual void GrabBegin()
    {
        ...
        if (closestGrabbable != null)
        {
            ...
            if (m_parentHeldObject)
            {
                actualParent = m_grabbedObj.transform.parent;
